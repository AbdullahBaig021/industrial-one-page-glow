            ...
            <div className="relative grid md:grid-cols-2 gap-10">
              <div>
                ...
                <div className="mt-8 space-y-4 text-sm">
                  <div className="flex items-start gap-3"><Mail className="h-5 w-5 text-primary mt-0.5 shrink-0" /> <span className="break-all">mufazimpex@gmail.com</span></div>
                  <div className="flex items-center gap-3"><Phone className="h-5 w-5 text-primary shrink-0" /> +886972197644</div>
                  <div className="flex items-start gap-3"><MapPin className="h-5 w-5 text-primary mt-0.5 shrink-0" /> <span>3rd Floor, No.3, Lane 982, Road Xiangxin South, Nantun District, Taichung City, Taiwan(R.O.C)</span></div>
                </div>
              </div>
